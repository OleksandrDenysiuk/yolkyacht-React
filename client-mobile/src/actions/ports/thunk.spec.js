...
import { getPorts, storeDeparturePortId, storeDestinationPortId, getSchedules } from './index';
...
describe('Call Actions for Ports reducer', () => {
  ...
  it('should create actions.Ports.STORE_DEPARTURE_PORT_ID action', () => {
  ...
  it('should create actions.Ports.STORE_DESTINATION_PORT_ID action', () => {
  ...
  it('should create actions.Ports.GET_PORTS/GET_PORTS_SUCCESS action', async () => {
    const ports = ['port1', 'port2'];
    const axiosMock = new MockAdapter(axios);
    const expectedActions = [
      { type: actions.Ports.GET_PORTS },
      { type: actions.Ports.GET_PORTS_SUCCESS, payload: ports }
    ]
  ...
  it('should create actions.Ports.GET_PORTS/GET_PORTS_FAILURE action', async () => {
    const serverBadResult = 'Failed to get Ports';
    const axiosMock = new MockAdapter(axios);
    const expectedActions = [
      { type: actions.Ports.GET_PORTS },
      { type: actions.Ports.GET_PORTS_FAILURE, payload: serverBadResult }
    ]
